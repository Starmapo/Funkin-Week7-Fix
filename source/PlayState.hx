...
class PlayState extends MusicBeatState
{
	...
	function ughIntro()
	{
		...
		var vid:FlxVideo = new FlxVideo('music/ughCutscene.mp4', function()
		{
			remove(blackShit);
	...
	function gunsIntro()
	{
		...
		var vid:FlxVideo = new FlxVideo('music/gunsCutscene.mp4', function()
		{
			remove(blackShit);
	...
	function stressIntro()
	{
		...
		var vid:FlxVideo = new FlxVideo('music/stressCutscene.mp4', function()
		{
			remove(blackShit);
